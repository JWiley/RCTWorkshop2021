...
SAVE study. The SAP can be accessed here:
https://journals.sagepub.com/doi/suppl/10.1177/1747493015607504/suppl_file/SAVE_SAP_v1_10July2015.pdf
...
you can read the results in without re-running it. In terms of time, on my system,
it took about 30 seconds to run. That is with 24 CPU cores. Its roughly linear scaling,
...
An example dataset for the SMART is available from the GitHub repo. 
...
Download the file from GitHub if desired.
